...
const Filter: React.FC<FilterProps> = ({ users, setFilteredUsers }) => {
  ...
  useEffect(() => {
    ...
    if (highlightOldest && city) {
      // Finde den ältesten Benutzer pro Stadt
      ...
      // Markiere den ältesten Benutzer
      filtered = filtered.map((user) => ({
        ...user,
        isOldestInCity: user.id === oldestUser.id, // Neue Eigenschaft, um den ältesten Benutzer zu markieren
      }));
    }
